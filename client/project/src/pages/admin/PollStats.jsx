...
export default function PollStats() {
  ...
  // Determine leading option text safely
  const leadingOptionText =
    stats?.predicted_winner?.option_text || poll.options?.[0]?.option_text || 'N/A';
        ...
        <Card>
          ...
          <div className="space-y-4">
            {poll.options?.map((option) => {
              ...
              // Compare leading option safely
              const isLeading =
                leadingOptionText === option.option_text ||
                (poll.options.every((o) => !o.vote_count) &&
                  poll.options[0]?.option_text === option.option_text);
          ...
          {stats?.predicted_winner?.option_text && (
            <div className="mt-6 p-4 bg-yellow-100 border border-yellow-300 rounded-lg">
              <p className="text-yellow-800 font-medium">
                Predicted Winner: {stats.predicted_winner.option_text}
              </p>
            </div>
          )}
        </Card>
